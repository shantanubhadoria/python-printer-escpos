...
#html_title = u'python-printer-escpos v0.0.2'
...
# This value selects if automatically documented members are sorted alphabetical (value 'alphabetical'), by member type
# (value 'groupwise') or by source order (value 'bysource'). The default is alphabetical.
