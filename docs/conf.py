...
#html_title = u'python-escpos v0.0.1a'
...
latex_documents = [
    (master_doc, 'python-escpos.tex', u'python-escpos Documentation',
...
man_pages = [
    (master_doc, 'python-escpos', u'python-escpos Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'python-escpos', u'python-escpos Documentation',
     author, 'python-escpos', 'One line description of project.',
     'Miscellaneous'),
]
