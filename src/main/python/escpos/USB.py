...
class Printer():
    ...
    def __init__(self, idVendor, idProduct, interface=0, inputEndPoint=0x82, outputEndPoint=0x01, commandSet='Generic'):
        """
        ...
        @param commandSet     : Printer command set to use, default 'Generic' for common escpos printers
        """
